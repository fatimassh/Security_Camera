...
def ring_phone():
    ...
    driver = webdriver.Firefox(options = options, executable_path="/Users/fo6em/Desktop/securityCamera/geckodriver")
    ...
    driver.find_element_by_css_selector("[title^='Fatima']").click()
